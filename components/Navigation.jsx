...
export default function Navigation() {
    ...
    return (
        <>
            ...
            <Link href="/" className="items-center hidden px-5 py-2 font-medium text-gray-800 bg-white border border-gray-600 rounded-full shadow lg:inline-flex hover:bg-gray-100">
